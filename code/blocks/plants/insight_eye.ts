namespace Plants {
  ...
  setupBlockModel(BlockID["insight_eye_top"], {
    model: "insight_eye",
    texture: "insight_eye",
  });
  ...
  export const INSIGHT_EYE_ITEM = new FItem("insight_eye", 1)
    .setInventoryModel("insight_eye", "insight_eye", {
      scale: [0.9, 0.9, 0.9],
