class Factory {
    public field: { result: ItemInstance, input: ItemInstance[], properties?: Record<string, any> }[] = [];

    public registerRecipe(result: ItemInstance, input: ItemInstance[], properties?: Record<string, unknown>): this {
        this.field.push({
            result: result,
            input: input,
