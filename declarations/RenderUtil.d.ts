...
declare namespace RenderUtil {
    ...
    class Model {
        addBoxByBlock(name:string, x1:number, y1:number, z1:number, x2:number, y2:number, z2:number, id:number|string|[string, number][], data?:number, CONDITION?: ICRender.CONDITION): Model;
        addBox(name:string, x1:number, y1:number, z1:number, x2:number, y2:number, z2:number, id:number|string|[string, number][], data?:number, CONDITION?: ICRender.CONDITION): Model;
        add(x1:number, y1:number, z1:number, x2:number, y2:number, z2:number, id:number|string|[string, number][], data?:number, CONDITION?: ICRender.CONDITION): Model;
